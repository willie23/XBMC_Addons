...
# filelist caching is redundant to m3u's, but eliminates repetitive off-site parsing.
# General
...
parserYT = StorageServer.StorageServer("plugin://script.pseudotv.live/" + "parserYT",((24 * 7) * 4))       #No Purge (Youtube/Viemo Queries)
