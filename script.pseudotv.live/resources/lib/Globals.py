...
# actions
ACTION_MOVE_LEFT = [1,ACTION_GESTURE_SWIPE_LEFT_TEN]
ACTION_MOVE_RIGHT = [2,ACTION_GESTURE_SWIPE_RIGHT_TEN]
...
ACTION_SELECT_ITEM = [7,ACTION_TOUCH_TAP,ACTION_GESTURE_SWIPE_RIGHT]
ACTION_PREVIOUS_MENU = [9, 10, 92, 247, 257, 275, 61467, 61448]
ACTION_DELETE_ITEM = 80
ACTION_SHOW_INFO = [11,ACTION_TOUCH_LONGPRESS,ACTION_GESTURE_SWIPE_LEFT]
ACTION_PAUSE = 12
...
ACTION_CONTEXT_MENU = [117,ACTION_TOUCH_LONGPRESS_TEN]
